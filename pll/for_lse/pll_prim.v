...
// Netlist written on Sun Sep 01 05:48:02 2019
// Source file index table: 
// Object locations will have the form @<file_index>(<first_ line>[<left_column>],<last_line>[<right_column>])
// file 0 "c:/development/fpga/spin_clock_ice/pll/rtl/pll.v"
...
module pll (ref_clk_i, rst_n_i, outcore_o, outglobal_o, outcoreb_o, 
            outglobalb_o);   /* synthesis lineinfo="@0(10[8],10[11])"*/
    ...
    output outcoreb_o;   /* synthesis lineinfo="@0(15[12],15[22])"*/
    output outglobalb_o;   /* synthesis lineinfo="@0(16[12],16[24])"*/
    ...
    wire outcoreb_o_c /* synthesis is_clock=1 */ ;   /* synthesis lineinfo="@0(15[12],15[22])"*/
    wire outglobalb_o_c /* synthesis is_clock=1 */ ;   /* synthesis lineinfo="@0(16[12],16[24])"*/
    
    wire GND_net, rst_n_i_c, VCC_net;
    
    OB outglobalb_o_pad (.I(outglobalb_o_c), .O(outglobalb_o));   /* synthesis lineinfo="@0(16[12],16[24])"*/
    VLO i1 (.Z(GND_net));
    OB outcoreb_o_pad (.I(outcoreb_o_c), .O(outcoreb_o));   /* synthesis lineinfo="@0(15[12],15[22])"*/
    ...
    \pll_ipgen_lscc_pll(DIVR="0",DIVF="21",DIVQ="5",FILTER_RANGE="4",PLLOUT_SELECT_PORTA="GENCLK",PLLOUT_SELECT_PORTB="GENCLK",FREQUENCY_PIN_REFERENCECLK="48.000000")  lscc_pll_inst (.GND_net(GND_net), 
            ...
            .outglobal_o_c(outglobal_o_c), .outcoreb_o_c(outcoreb_o_c), 
            .outglobalb_o_c(outglobalb_o_c));   /* synthesis lineinfo="@0(18[41],18[332])"*/
    VHI i75 (.Z(VCC_net));
...
module \pll_ipgen_lscc_pll(DIVR="0",DIVF="21",DIVQ="5",FILTER_RANGE="4",PLLOUT_SELECT_PORTA="GENCLK",PLLOUT_SELECT_PORTB="GENCLK",FREQUENCY_PIN_REFERENCECLK="48.000000")  (GND_net, 
            ref_clk_i_c, rst_n_i_c, outcore_o_c, outglobal_o_c, outcoreb_o_c, 
            outglobalb_o_c);
    input GND_net;
    input ref_clk_i_c;
    input rst_n_i_c;
    ...
    PLL_B u_PLL_B (.REFERENCECLK(ref_clk_i_c), .FEEDBACK(feedback_w), .DYNAMICDELAY7(GND_net), 
          ...
          .OUTCORE(outcore_o_c), .OUTGLOBAL(outglobal_o_c), .OUTCOREB(outcoreb_o_c), 
          .OUTGLOBALB(outglobalb_o_c)) /* synthesis syn_instantiated=1, LSE_LINE_FILE_ID=23, LSE_LCOL=41, LSE_RCOL=332, LSE_LLINE=18, LSE_RLINE=18 */ ;   /* synthesis lineinfo="@0(18[41],18[332])"*/
