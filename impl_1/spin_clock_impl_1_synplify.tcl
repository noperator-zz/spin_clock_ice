...
set_option -include_path {C:/development/FPGA/spin_clock_ice/pll}
set_option -include_path {C:/development/FPGA/spin_clock_ice/smi_fifo}
...
project -log_file {spin_clock_impl_1.srf}
project -run -clean
